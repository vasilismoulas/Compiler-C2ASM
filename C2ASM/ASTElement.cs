...
namespace C2ASM
{
    ...
    public enum nodeType   //This enumeration refers to the terminal nodes or the ones that are being structured by contexts 
    {
        ...
        NT_FUNCTIOΝDEFINITION = 5,  //4
        NT_FUNPREFIX = 8,
        NT_FUNCTIONBODY = 10,
        NT_STATEMENT = 11,
        NT_STATEMENT_RETURN = 12,
        NT_STATEMENT_BREAK = 13,
        NT_IFSTATEMENT = 14,
        NT_WHILESTATEMENT = 17,
        NT_COMPOUNDSTATEMENT = 19,
        NT_STATEMENTLIST = 21,
        NT_DATADECLARATION = 22,    //22
        ...
        NT_STATEMENT_EXPRESSION = 32,
        NT_EXPRESSION_NUMBER = 30,
        NT_EXPRESSION_IDENTIFIER = 31,
        NT_EXPRESSION_CHAR = 32,
        NT_EXPRESSION_FCALL = 33,
        NT_EXPRESSION_MULTIPLICATION = 34,
        NT_EXPRESSION_DIVISION = 39,
        NT_EXPRESSION_ADDITION = 41,
        NT_EXPRESSION_SUBSTRACTION = 43,
        NT_EXPRESSION_PLUS = 45,
        NT_EXPRESSION_MINUS = 46,
        NT_EXPRESSION_PARENTHESIS = 47,
        NT_EXPRESSION_ASSIGN = 48,
        NT_EXPRESSION_NOT = 50,
        NT_EXPRESSION_AND = 52,
        NT_EXPRESSION_OR = 54,
        NT_EXPRESSION_GT = 56,
        NT_EXPRESSION_GTE = 58,
        NT_EXPRESSION_LT = 60,
        NT_EXPRESSION_LTE = 63,
        NT_EXPRESSION_EQUAL = 64,
        NT_EXPRESSION_NEQUAL = 66,
        NT_FARGUMENTS = 67,
